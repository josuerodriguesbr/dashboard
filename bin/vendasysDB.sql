...
DROP TABLE IF EXISTS `cred_trans_tipos`;
CREATE TABLE `cred_trans_tipos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `usuarios` (
  ...
  CONSTRAINT `fk_usuario_parent` FOREIGN KEY (`parent_id`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL
...
CREATE TABLE `recargas` (
  ...
  CONSTRAINT `fk_recargas_usuario_original` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `logs` (
  ...
  CONSTRAINT `fk_logs_usuario_acao` FOREIGN KEY (`usuarioId`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `sessoes` (
  ...
  CONSTRAINT `fk_sessao_usuario` FOREIGN KEY (`usuarioId`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4;

DROP TABLE IF EXISTS `itens_adquiridos`;
CREATE TABLE `itens_adquiridos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `usuario_id` int(11) NOT NULL,
  ...
  CONSTRAINT `fk_itens_recurso_orig` FOREIGN KEY (`recurso_id`) REFERENCES `recursos` (`id`),
  CONSTRAINT `fk_itens_usuario_orig` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

DROP TABLE IF EXISTS `logs_gateway`;
CREATE TABLE `logs_gateway` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_logs_gateway_recarga` FOREIGN KEY (`recarga_id`) REFERENCES `recargas` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

DROP TABLE IF EXISTS `credito_transacoes`;
CREATE TABLE `credito_transacoes` (
  ...
  CONSTRAINT `fk_trans_recarga_orig` FOREIGN KEY (`recarga_id`) REFERENCES `recargas` (`id`),
  CONSTRAINT `fk_trans_tipo_orig` FOREIGN KEY (`tipo_id`) REFERENCES `cred_trans_tipos` (`id`),
  CONSTRAINT `fk_trans_usuario_orig` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
