...
public function paginaInicial()
{
    ...
    try {
        ...
        $data = [
            'title' => 'Login',
            'layout' => 'form',
            'ignorarAutenticacao' => true // Importante para não entrar em loop
        ];    
    ...
    public function serverLogs()
    {
        try {
            ...
            $data = [
                ...
                'layout' => ($usuario['nivel'] === 'admin') ? 'admin' : 'main'
            ];
    ...
    public function cadastroUsuario()
    {
        ...
        try {
            ...
            setcookie('authToken', $resultadoSessao['token'], [
               ...
               // Em vez de $_ENV['JWT_EXPIRE'], use diretamente a constante JWT_EXPIRE
